...
dic={"1":"run.stronglyConnectedMain()", "2":"run.check_cycleMain()", "3":"run.dijkstraShortestPath", "4":None, "5":"run.printGraph()", "6":"exit()", "help":None}  #store functionality
